#!/usr/bin/env python3
"""Train pykt DKT on EdNet — pyKT standard config."""
...
print(f"{'='*60}")
print(f"Training pykt DKT on EdNet (pyKT standard config)")
...
ckpt_path = 'outputs/checkpoints/pykt_dkt_best_ednet.pt'
